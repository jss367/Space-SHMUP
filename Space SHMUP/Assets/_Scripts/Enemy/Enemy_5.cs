...
public class Enemy_5 : Enemy {
	// Enemy_5 will start offscreen and then pick a random point on screen to move to. Once it has arrived, it will pick another
	// random point and continue until that player has shot it down.

	public Vector3[]			points; // Stores the p0 and p1 for interpolation
	public float				timeStart; // Birth time for this Enemy_5
	public float				duration = 4; // Duration of the 
