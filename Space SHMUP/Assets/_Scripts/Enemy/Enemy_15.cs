...
public class Enemy_15 : Enemy {
	// Because Enemy_15 extends Enemy, the _______ bool won't work the same way in the Inspector pane. Much sadness
	...
	public override void Move() {
		...
		Vector3 rot = new Vector3(90, 180 + sin*waveRotY, 0);
