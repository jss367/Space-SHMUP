...
public class PowerUp_Tutorial : MonoBehaviour {
	...
	public WeaponType_Tutorial		type; // The type of the PowerUp
	...
	public void SetType( WeaponType_Tutorial wt) {
		...
		WeaponDefinition_Tutorial def = Main_Tutorial.GetWeaponDefinition(wt);
